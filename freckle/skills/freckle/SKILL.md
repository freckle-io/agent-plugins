...
- **A vague status ask still gets a complete answer.** When someone asks "where are we at", "what happened lately", or "can you get it going", do not stop at a summary plus an offer. Before offering anything further, state the numbers they will need next: how many are done, how many are left, and what the remaining work will cost — or, for monitoring, how many events fired in the window and whether anything needs creating. Then offer the deeper dig in one line.
