...
- Skip a fallback only when its contract does not fit the pinned objective, a required org credential is missing, or the user explicitly chose a different fallback policy.
