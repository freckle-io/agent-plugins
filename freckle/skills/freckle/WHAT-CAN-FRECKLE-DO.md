...
- Connect integrations: open Freckle's web app to connect Apify, ContactOut, HeyReach, HubSpot, Instantly, Salesforce, Slack, or Supabase credentials, list connection status, and inspect public credential IDs.
