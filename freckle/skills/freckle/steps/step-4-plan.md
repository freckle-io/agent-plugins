...
- **Keep the prose short.** State the assumptions you made as short bullets and the cost as one line (credits per row × rows ≈ total). The diagram and the tables below carry the plan; do not narrate them.
